return {
...

	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>hf", ":DiffviewFileHistory %<CR>", { noremap = true, silent = true, desc = "[F]ile [H]istory %" })
			vim.keymap.set("n", "<leader>ha", ":DiffviewFileHistory<CR>", { noremap = true, silent = true, desc = "[H]istory [A]ll" })
			vim.keymap.set("n", "<leader>hc", ":DiffviewClose<CR>", { noremap = true, silent = true, desc = "[H]istory [C]lose" })
